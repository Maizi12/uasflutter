...
abstract class $UsersCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String namaUser, int id});
}
...
class _$UsersImpl implements _Users {
  const _$UsersImpl(
      {required this.email, required this.namaUser, required this.id});
  ...
  @override
  String toString() {
    return 'Users(email: $email, namaUser: $namaUser, id: $id)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, email, namaUser, id);
...
abstract class _Users implements Users {
  const factory _Users(
      ...
      required final String namaUser,
      required final int id}) = _$UsersImpl;
