...
class _$LoadingImpl implements _Loading {
  const _$LoadingImpl(
      {final List<GetWalletModel> wallets = const [],
      this.selectedWallet,
      this.currentPage = 1,
      this.hasMoreTransactions = true})
      : _wallets = wallets;

  final List<GetWalletModel> _wallets;
  @override
  @JsonKey()
  List<GetWalletModel> get wallets {
  ...
  @override
  String toString() {
    return 'WalletState.loading(wallets: $wallets, selectedWallet: $selectedWallet, currentPage: $currentPage, hasMoreTransactions: $hasMoreTransactions)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loading(wallets, selectedWallet, currentPage, hasMoreTransactions);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loading?.call(
        wallets, selectedWallet, currentPage, hasMoreTransactions);
  }
...
class __$$LoadedImplCopyWithImpl<$Res>
  ...
  $Res call({
    Object? wallets = null,
    Object? selectedWallet = null,
    Object? currentPage = null,
    Object? hasMoreWallets = null,
    ...
    return _then(_$LoadedImpl(
      wallets: null == wallets
          ...
          : wallets // ignore: cast_nullable_to_non_nullable
              as List<GetWalletModel>,
      selectedWallet: null == selectedWallet
          ? _value.selectedWallet
          : selectedWallet // ignore: cast_nullable_to_non_nullable
              as GetWalletModel,
      currentPage: null == currentPage
          ...
          : currentPage // ignore: cast_nullable_to_non_nullable
              as int,
      hasMoreWallets: null == hasMoreWallets
          ? _value.hasMoreWallets
          : hasMoreWallets // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<GetWalletModel> wallets,
      required this.selectedWallet,
      this.currentPage = 1,
      this.hasMoreWallets = true,
  ...
  @override
  String toString() {
    return 'WalletState.loaded(wallets: $wallets, selectedWallet: $selectedWallet, currentPage: $currentPage, hasMoreWallets: $hasMoreWallets, isLoadingMore: $isLoadingMore)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.currentPage, currentPage) ||
                other.currentPage == currentPage) &&
            (identical(other.hasMoreWallets, hasMoreWallets) ||
                other.hasMoreWallets == hasMoreWallets) &&
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(
        wallets, selectedWallet, currentPage, hasMoreWallets, isLoadingMore);
  }
...
abstract class _Loaded implements WalletState {
  const factory _Loaded(
      {required final List<GetWalletModel> wallets,
      required final GetWalletModel selectedWallet,
      final int currentPage,
      final bool hasMoreWallets,
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'WalletState.error(message: $message, wallets: $wallets, selectedWallet: $selectedWallet, currentPage: $currentPage, hasMoreTransactions: $hasMoreTransactions)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(
        message, wallets, selectedWallet, currentPage, hasMoreTransactions);
  }
